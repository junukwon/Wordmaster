...
WordMaster는 중학생이 DAY 5개분인 신규 단어 125개를 영어→뜻, 뜻→영어, Apple Pencil 철자 필기로 집중 학습하고 D+1·3·7·14 복습과 수시 테스트를 이어갈 수 있는 로컬 우선 PWA입니다. 로그인, 서버, 손글씨 자동 인식, 음성 인식, 발음 평가는 포함하지 않습니다.
