...
WordMaster는 중학생이 DAY 01~10에서 원하는 DAY를 골라 신규 단어 25~250개를 영어→뜻, 뜻→영어, Apple Pencil 철자 필기로 집중 학습하고 D+1·3·7·14 복습과 수시 테스트를 이어갈 수 있는 로컬 우선 PWA입니다. 로그인, 서버, 손글씨 자동 인식, 음성 인식, 발음 평가는 포함하지 않습니다.
...
1. `content/source/영어_단어_DAY01-10.md`의 형식과 연속 번호를 유지해 새 `## DAY NN — 주제`와 25개 행을 추가합니다.
...
- 이후 앱 화면, JavaScript, CSS, 아이콘, DAY 01~10 JSON은 캐시되어 앱 시작, 단어 학습, Apple Pencil 필기, 진도 저장, 수시 테스트가 오프라인에서 동작합니다.
